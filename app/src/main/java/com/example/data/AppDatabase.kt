...
import com.example.data.dao.DirectMessageDao
...
@Database(entities = [Song::class, Mosaic::class, WorshipCommand::class, TodayListHistory::class, DirectMessageEntity::class], version = 4, exportSchema = false)
